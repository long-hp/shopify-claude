...
the workflow in `.claude/skills/system-audit/SKILL.md`. Scoring rules are
documented in `.claude/skills/system-audit/references/rubric.md`.

Usage:
    python .claude/skills/system-audit/scripts/audit-static.py            # JSON
    python .claude/skills/system-audit/scripts/audit-static.py --human    # short human summary
    python .claude/skills/system-audit/scripts/audit-static.py --repo-root /path/to/repo
